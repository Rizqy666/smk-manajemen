        ...
        <div class="col-md-12">
            <div class="col-lg-12">
                <div class="row">
                    ...
                    <div class="col-xxl-4 col-md-6">
                        <div class="card info-card sales-card border-primary shadow-sm">
                            <div class="card-body">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\smk-management\resources\views/dashboard/index.blade.php ENDPATH**/ ?>